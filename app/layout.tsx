...
export const metadata: Metadata = {
  title: {
    default: "Website Resmi SD Negeri Loji 3 Kota Bogor",
    template: "%s | Website Resmi SD Negeri Loji 3 Kota Bogor",
  },
  ...
  verification: {
    google: "Cr_7wIp44VTsgH3TR8oEf7_5rwx_-_scwYOzsDbwwrY",
  },
  icons: {
  ...
  openGraph: {
    type: "website",
    title: "Website Resmi SD Negeri Loji 3 Kota Bogor",
    description: "Terwujudnya peserta didik yang cerdas, terampil, dan berbudaya berdasarkan IMTAQ dan IPTEK.",
